...
({
    ...
    doCompare : function(component, adapterUrl, baseUrl) {
        var shouldBeAdapterUrl = baseUrl + '/apex/demoAdapterPage';
        var adapterUrlLower = adapterUrl.toLowerCase();
        var shouldBeAdapterUrlLower = shouldBeAdapterUrl.toLowerCase();

        if(adapterUrlLower == shouldBeAdapterUrlLower) {
            console.log('match!');
            // do nothing?
        } else {
            console.log('not a match :( ');
            // component.set('v.correctAdapter', shouldBeAdapterUrl);
            // component.set('v.wrongAdapterUrl', true);
            // this.showTheModal(component);
        }
    },
